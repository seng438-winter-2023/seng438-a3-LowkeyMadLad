...
public class RangeTest {
	...
	public void test_getCentralValue_NominalValues(){
		...
		assertEquals("getCentral Value for nominal Range",
				4.0, testRange1.getCentralValue(), .000000001d);
	}
    ...
    public void test_toString_maxRangeToString() {
    	assertEquals("Maximum upper to string",
    			"Range[1.0,1.79769313486231570E308]", maxRange.toString());
    }
    
    @Test
    public void test_toString_minRangeToString() {
    	assertEquals("Minimum lower to string",
    			"Range[2.2250738585072014E-308,1.0]", minRange.toString());
    }
	...
	public void test_inersects_testTouchingBoundsLower() {
		assertTrue("Range values 3,5 touches the lower bound, should return true.", test5Range.intersects(3, 5));
	}
	...
	public void test_inersects_testTouchingBoundsUpper() {
		assertTrue("Range values 10,11 touches the upper bound, should return true.", test5Range.intersects(10, 11));
	}
	...
	public void test_inersects_test2TouchingBoundsLower() {
		assertTrue("Range values 3,5 touches the lower bound, should return true.", test6Range.intersects(3, 5));
	}
	...
	public void test_inersects_test2SameRangeValues() {
		assertTrue("Range values of 5,5 match the test6Range. Should return true", test6Range.intersects(5, 5));
	}
